                            ...
                            <form method="POST" action="/submit">
                                <div class="modal-top-box">
                                    ...
                                    <div class="modal-top-md-box">
                                        ...
                                        <div class="modal-top-delete-box">
                                            <a href="/user/mypage/${userNum}">저 장</a>
                                        </div>
                                    </div>
                                ...
                                <div class="modal-middle-box">
                                    <div class="modal-middle-rate-content-box">
                                        <textarea name="modal-content" id="modal-content" cols="30"
                                            rows="10"></textarea>
                                                        ...
                                                        <c:forEach items="${reviews}" var="review">
                                                            <div class="review-container">
                                                                ...
                                                                <div class="review-box" id="reviewBox">
                                                                    ...
                                                                    <p class="r-rateReview">평가 내용 : ${review.rateReview}
                                                                    </p>
        ...
        <script>
            ...
            reviewContainers.forEach(container => {
                container.addEventListener('click', function () {
                    const reviewId = this.querySelector('.review-box').id; // 리뷰 식별자 값을 가져옴

                    // AJAX 요청을 통해 서버에서 해당 리뷰 정보를 가져옴
                    fetch(`/api/reviews/${reviewId}`)
                        .then(response => response.json())
                        .then(data => {
                            const movieTitle = data.movieTitle;
                            const rateReview = data.rateReview;
                            const rateScore = data.rateScore;

                            const reviewText =
                                `영화 제목: ${movieTitle}\n평가 내용: ${rateReview}\n영화 평점: ${rateScore}`;

                            modalTextarea.value = reviewText;
