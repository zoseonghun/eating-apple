    ...
    <script>
        ...
        $pwCheckInput.onkeyup = e => {
            ...
            if (pwCheckValue.trim() === '') {
                ...
                $pwCheckInput.style.borderColor = 'red';
                document.getElementById('pwChk2').innerHTML
                    = '<b style="color: red;">[비밀번호를 똑같이 쓰세요!]</b>';
                checkResultList[2] = false;
            } else {

                $pwCheckInput.style.borderColor = 'skyblue';
                document.getElementById('pwChk2').innerHTML
                    = '<b style="color: skyblue;">[비밀번호가 동일합니다.]</b>';
        ...
        $ageInput.onkeyup = e => {
            ...
            if (ageValue === '') {
                ...
                document.getElementById('ageChk').innerHTML
                    = ‘<b style=“color: red;”>[나이는 필수 정보입니다.]</b>’;
                checkResultList[4] = false;
            } else if (!agePattern.test(ageValue)) {
                $ageInput.style.borderColor = `red`;
                document.getElementById(‘ageChk’).innerHTML
                    = '<b style=“color: red;”>[10세부터 80세까지 입력해주세요.]</b>';
                checkResultList[4] = false;
            } else {
                $ageInput.style.borderColor = `skyblue`;
                document.getElementById(‘ageChk’).innerHTML
                    = ‘<b style=“color: skyblue;”>[사용 가능한 나이입니다.]</b>’;
        ...
        function validateGender() {
            if (genderMaleInput.checked || genderFemaleInput.checked) {
                ...
                document.getElementById('genderChk').innerHTML
                    = ‘<b style=“color: red;”>[성별을 선택해주세요.]</b>’;
